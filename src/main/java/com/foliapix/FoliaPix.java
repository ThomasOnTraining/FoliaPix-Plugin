...
public class FoliaPix extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getCommand("registrar").setExecutor(new com.foliapix.commands.RegistrarCommand());
        getServer().getPluginManager().registerEvents(new com.foliapix.gui.GuiListener(), this);
